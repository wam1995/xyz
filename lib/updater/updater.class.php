...
if ( ! defined( 'ABSPATH' ) || class_exists( 'WPGitHubUpdater' ) || class_exists( 'WP_PlugGIt' ) )
    return;
 ...
 *
 * @version 1.8
 * @author Sondre Dyrnes <sondre@nettfrihet.no>
 * @link https://www.nettfrihet.no
 * @package PlugGit
 * @license http://www.gnu.org/copyleft/gpl.html GNU Public License
 * @copyright Copyright (c) 2019, Sondre Dyrnes
 *
 */
class WP_PlugGIt {
